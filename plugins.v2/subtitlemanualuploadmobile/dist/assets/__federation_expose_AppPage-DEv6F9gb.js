...
function resolvePluginBase(pluginBase) {
  ...
  return raw || 'plugin/SubtitleManualUploadMobile'
}
...
const _hoisted_5$8 = { class: "ai-task-main" };
                ...
                ? (_openBlock$d(), _createElementBlock$c("div", _hoisted_3$c, [
                    (_openBlock$d(true), _createElementBlock$c(_Fragment$b, null, _renderList$9(__props.aiDialogTasks, (task) => {
                      return (_openBlock$d(), _createElementBlock$c("div", {
                        ...
                        _createElementVNode$d("div", _hoisted_5$8, [
...
const _hoisted_4$7 = { class: "poster-frame compact" };
const _hoisted_5$6 = ["src", "alt", "loading", "fetchpriority", "onError"];
const _hoisted_6$6 = { key: 1 };
const _hoisted_7$6 = { class: "media-copy" };
const _hoisted_8$5 = { class: "media-type" };
const _hoisted_9$5 = {
  key: 0,
  class: "global-history-targets"
};
const _hoisted_10$5 = { class: "history-bulk-toolbar" };
const _hoisted_11$5 = { class: "history-bulk-copy" };
const _hoisted_12$4 = { class: "history-bulk-actions" };
const _hoisted_13$4 = { class: "history-season-tree" };
const _hoisted_14$4 = {
  key: 0,
...
return (_ctx, _cache) => {
  ...
  return (_openBlock$a(), _createElementBlock$9(_Fragment$8, null, [
    ...
    (__props.rootTab === 'history' && __props.matchHistoryItems.length)
          ...
          (_openBlock$a(true), _createElementBlock$9(_Fragment$8, null, _renderList$6(__props.matchHistoryItems, (item, index) => {
            return (_openBlock$a(), _createElementBlock$9("div", {
              ...
              _createElementVNode$a("button", {
                ...
                _createElementVNode$a("div", _hoisted_4$7, [
                  (__props.posterImageSrc(item))
                    ...
                    : (_openBlock$a(), _createElementBlock$9("span", _hoisted_6$6, _toDisplayString$8(__props.formatMediaType(item.media_type)), 1))
                ]),
                _createElementVNode$a("div", _hoisted_7$6, [
                  _createElementVNode$a("div", _hoisted_8$5, _toDisplayString$8(__props.formatMediaType(item.media_type)), 1),
                  _createElementVNode$a("h3", null, _toDisplayString$8(__props.mediaLabel(item)), 1),
                  _createElementVNode$a("p", null, _toDisplayString$8(__props.historyMediaStat(item)) + " · " + _toDisplayString$8(item.latest_at || '未知时间'), 1)
                ]),
              ...
              (__props.historyExpanded(item))
                ? (_openBlock$a(), _createElementBlock$9("div", _hoisted_9$5, [
                    _createElementVNode$a("div", _hoisted_10$5, [
                      _createElementVNode$a("div", _hoisted_11$5, [
                        ...
                        _createElementVNode$a("span", null, _toDisplayString$8(item.subtitle_count) + " 个外挂字幕", 1)
                      ]),
                    ...
                    _createElementVNode$a("div", _hoisted_13$4, [
                      (_openBlock$a(true), _createElementBlock$9(_Fragment$8, null, _renderList$6(__props.historySeasonGroups(item), (season) => {
                        return (_openBlock$a(), _createElementBlock$9("div", {
                          ...
                          (!season.direct)
                            ? (_openBlock$a(), _createElementBlock$9("div", _hoisted_14$4, [
                                ...
                                _createElementVNode$a("button", {
                                  ...
                                  _createElementVNode$a("span", null, _toDisplayString$8(season.targets.length) + " 集 · " + _toDisplayString$8(season.subtitleCount) + " 个外挂字幕", 1),
                                  (__props.historySeasonSelectedCount(item, season))
                                    ? (_openBlock$a(), _createElementBlock$9("em", _hoisted_16$3, "已选 " + _toDisplayString$8(__props.historySeasonSelectedCount(item, season)), 1))
                                    : _createCommentVNode$9("", true)
                                ], 8, _hoisted_15$4)
                              ]))
                            : _createCommentVNode$9("", true),
                                  ...
                                  return (_openBlock$a(), _createElementBlock$9("div", {
                                    ...
                                    _createElementVNode$a("div", _hoisted_17$3, [
                                      ...
                                      _createElementVNode$a("button", {
                                        ...
                                        _createElementVNode$a("span", _hoisted_19$3, _toDisplayString$8(__props.compactTargetName(target)), 1),
                                        _createElementVNode$a("small", null, _toDisplayString$8((target.subtitles || []).length) + " 个外挂字幕", 1)
                                      ], 8, _hoisted_18$3),
                                      _createVNode$9(_component_VBtn, {
                                        size: "small",
                                        variant: "tonal",
                                    ...
                                    (__props.historyTargetExpanded(target))
                                      ? (_openBlock$a(), _createElementBlock$9("div", _hoisted_20$3, [
                                          _createElementVNode$a("div", _hoisted_21$2, _toDisplayString$8(target.relative_path), 1),
                                          (target.timeline_task)
                                            ? (_openBlock$a(), _createElementBlock$9("div", _hoisted_22$1, [
                                          ...
                                          _createElementVNode$a("div", _hoisted_23$1, [
                                            (_openBlock$a(true), _createElementBlock$9(_Fragment$8, null, _renderList$6(target.subtitles, (subtitle) => {
                                              return (_openBlock$a(), _createElementBlock$9("div", {
                                                ...
                                                _createElementVNode$a("div", _hoisted_25$1, [
                                                  _createVNode$9(_component_VBtn, {
                                                    size: "small",
                                                    variant: "tonal",
                                                    color: "warning",
                    ...
                    (!__props.historySeasonGroups(item).length)
                      ? (_openBlock$a(), _createElementBlock$9("div", _hoisted_26$1, " 暂无可管理的外挂字幕 "))
                      : _createCommentVNode$9("", true)
                  ]))
                : _createCommentVNode$9("", true)
            ]))
      ...
      : _createCommentVNode$9("", true),
    (__props.rootTab === 'history' && __props.matchHistoryItems.length)
      ? (_openBlock$a(), _createElementBlock$9("div", _hoisted_27$1, [
      ...
      : (__props.rootTab === 'history')
        ? (_openBlock$a(), _createElementBlock$9("div", _hoisted_28, _toDisplayString$8(__props.matchHistoryLoading ? '正在读取匹配历史...' : '还没有找到已匹配字幕记录。'), 1))
        : _createCommentVNode$9("", true)
  ], 64))
}
}
...
const _hoisted_2$7 = { class: "online-message-summary-content" };
const _hoisted_3$7 = { class: "online-layout" };
const _hoisted_4$6 = { class: "online-results-panel" };
const _hoisted_5$5 = { class: "online-panel-head" };
const _hoisted_6$5 = {
  key: 2,
...
const _hoisted_9$4 = { class: "online-result-main" };
const _hoisted_10$4 = { class: "online-result-title" };
const _hoisted_11$4 = { class: "online-result-meta" };
const _hoisted_12$3 = {
  key: 0,
            ...
            _createVNode$7(_component_VCardText, null, {
              default: _withCtx$5(() => [
                ...
                _createElementVNode$8("div", _hoisted_3$7, [
                  _createElementVNode$8("section", _hoisted_4$6, [
                    _createElementVNode$8("div", _hoisted_5$5, [
                      _cache[22] || (_cache[22] = _createElementVNode$8("div", null, [
                    ...
                    (__props.onlineProviderProgressItems.length)
                      ? (_openBlock$8(), _createElementBlock$8("div", _hoisted_6$5, [
                    ...
                    (__props.onlineSearching && !__props.filteredOnlineResults.length)
                      ? (_openBlock$8(), _createElementBlock$8("div", _hoisted_7$5, " 正在从 API 搜索字幕，先返回的结果会先显示... "))
                      : _createCommentVNode$8("", true),
                    (__props.filteredOnlineResults.length)
                      ? (_openBlock$8(), _createElementBlock$8("div", _hoisted_8$4, [
                  ...
                  disabled: !__props.isOnlineResultDownloadable(item),
                              ...
                              _createElementVNode$8("div", _hoisted_9$4, [
                                _createElementVNode$8("div", _hoisted_10$4, _toDisplayString$6(item.title), 1),
                                _createElementVNode$8("div", _hoisted_11$4, [
                                  ...
                                  (!__props.isOnlineResultDownloadable(item))
                                    ? (_openBlock$8(), _createElementBlock$8("span", _hoisted_12$3, " 需手动下载 "))
                                    : _createCommentVNode$8("", true)
                                ]),
                                (item.note)
                                  ? (_openBlock$8(), _createElementBlock$8("p", _hoisted_13$3, _toDisplayString$6(item.note), 1))
                                  : _createCommentVNode$8("", true),
                                (item.match_detail)
                                  ? (_openBlock$8(), _createElementBlock$8("p", _hoisted_14$3, _toDisplayString$6(item.match_detail), 1))
                                  : _createCommentVNode$8("", true)
                              ]),
                              (item.page_url)
                      ...
                      : (!__props.onlineSearching)
                        ? (_openBlock$8(), _createElementBlock$8("div", _hoisted_16$2, _toDisplayString$6(__props.hasOnlineResults ? '当前平台筛选下没有结果。' : '没有可自动下载的字幕结果。可以换关键词重试，或使用右侧手动搜索。'), 1))
                        : _createCommentVNode$8("", true)
                  ]),
                  _createElementVNode$8("aside", _hoisted_17$2, [
                    _cache[23] || (_cache[23] = _createElementVNode$8("div", { class: "section-kicker" }, "手动搜索", -1)),
                    _cache[24] || (_cache[24] = _createElementVNode$8("h3", null, "跳转字幕站", -1)),
                    _cache[25] || (_cache[25] = _createElementVNode$8("p", null, "自动搜索失败或源站需要验证时，可打开链接下载字幕包后回到本页上传。", -1)),
                    (_openBlock$8(true), _createElementBlock$8(_Fragment$7, null, _renderList$5(__props.onlineManualLinks, (provider) => {
                      return (_openBlock$8(), _createElementBlock$8("div", {
                        ...
                        _createElementVNode$8("div", _hoisted_18$2, [
                        ...
                        _createElementVNode$8("div", _hoisted_19$2, [
                          (_openBlock$8(true), _createElementBlock$8(_Fragment$7, null, _renderList$5(provider.links, (link) => {
                            return (_openBlock$8(), _createElementBlock$8("a", {
                              ...
                              target: "_blank",
                              rel: "noopener noreferrer"
                            }, _toDisplayString$6(link.keyword), 9, _hoisted_20$2))
                          }), 128))
                        ])
                      ]))
                    }), 128))
        ...
        _createVNode$7(_component_VCard, { rounded: "lg" }, {
          default: _withCtx$5(() => [
            _createVNode$7(_component_VCardTitle, { class: "dialog-title compact" }, {
              default: _withCtx$5(() => [
                _createElementVNode$8("div", null, [
                  _cache[26] || (_cache[26] = _createElementVNode$8("span", null, "确认提交 AI 翻译", -1)),
...
const _hoisted_10$3 = {
  key: 0,
  class: "toolbar-row batch-toolbar"
};
const _hoisted_11$3 = { class: "selection-summary" };
const _hoisted_12$2 = {
  key: 1,
  class: "episode-list"
};
const _hoisted_13$2 = { class: "episode-index" };
const _hoisted_14$2 = { class: "episode-copy" };
const _hoisted_15$2 = { class: "episode-title" };
const _hoisted_16$1 = { class: "episode-path" };
const _hoisted_17$1 = {
  key: 3,
  class: "episode-expanded"
};
const _hoisted_18$1 = { class: "history-status compact-status" };
...
const _hoisted_22 = { class: "subtitle-history-copy" };
const _hoisted_23 = { class: "subtitle-history-actions" };
const _hoisted_24 = {
  key: 1,
  class: "empty-state compact-empty"
};
...
const batchMenuOpen = ref$5(false);
...
return (_ctx, _cache) => {
  ...
  const _component_VSpacer = _resolveComponent$6("VSpacer");
        ...
        default: _withCtx$4(() => [
          ...
          _createElementVNode$6("div", _hoisted_9$3, [
            (__props.visibleTargets.length)
              ? (_openBlock$6(), _createElementBlock$6("div", _hoisted_10$3, [
                  _createVNode$6(_component_VBtn, {
                    ...
                    default: _withCtx$4(() => [
                      _createTextVNode$4(_toDisplayString$4(__props.allVisibleSelected ? '取消全选' : '全选'), 1)
                    ]),
                    _: 1
                  }),
                  _createElementVNode$6("div", _hoisted_11$3, [
                    _createElementVNode$6("strong", null, _toDisplayString$4(__props.selectedTargets.length), 1),
                    _createElementVNode$6("span", null, "已选 / " + _toDisplayString$4(__props.visibleTargets.length) + " 集", 1)
                  ]),
                  _createVNode$6(_component_VSpacer),
                  _createVNode$6(_component_VMenu, {
                    modelValue: batchMenuOpen.value,
                    "onUpdate:modelValue": _cache[12] || (_cache[12] = $event => ((batchMenuOpen).value = $event)),
                    location: "bottom end",
                    "close-on-content-click": true
                  }, {
                    activator: _withCtx$4(({ props: menuProps }) => [
                      _createVNode$6(_component_VBtn, _mergeProps$3(menuProps, {
                    ...
                    default: _withCtx$4(() => [
                      _createVNode$6(_component_VCard, {
                        class: "batch-menu-card",
                        "min-width": "292",
                        rounded: "xl"
                      }, {
                        default: _withCtx$4(() => [
                          _createVNode$6(_component_VList, {
                            density: "comfortable",
                            lines: "two"
                          }, {
                            default: _withCtx$4(() => [
                              _createVNode$6(_component_VListSubheader, null, {
                                default: _withCtx$4(() => [...(_cache[15] || (_cache[15] = [
                                  _createTextVNode$4("选择后执行", -1)
                                ]))]),
                                _: 1
                              }),
                              _createVNode$6(_component_VListItem, {
                                "prepend-icon": "mdi-upload",
                                title: __props.selectedTargets.length ? '上传选中字幕' : '上传整季字幕',
                                subtitle: "给已选集数匹配本地字幕文件",
                                disabled: !__props.unlockedVisibleTargets.length,
                                onClick: _cache[5] || (_cache[5] = $event => (_ctx.$emit('open-batch-upload')))
                              }, null, 8, ["title", "disabled"]),
                              _createVNode$6(_component_VListItem, {
                                "prepend-icon": "mdi-cloud-search-outline",
                                title: __props.onlineBatchLabel || '搜索在线字幕',
                                subtitle: "按当前选择搜索在线字幕包",
                                disabled: !__props.batchUploadTargets.length || __props.onlineSearching,
                                onClick: _cache[6] || (_cache[6] = $event => (_ctx.$emit('open-batch-online-search')))
                              }, null, 8, ["title", "disabled"]),
                              (__props.aiEnabled)
                                ? (_openBlock$6(), _createBlock$6(_component_VListItem, {
                                    key: 0,
                                    "prepend-icon": "mdi-robot-outline",
                                    title: __props.aiBatchLabel || 'AI 生成字幕',
                                    subtitle: "对可处理集数提交 AI 任务",
                                    disabled: !__props.aiCapableBatchTargets.length || !__props.aiAvailable || __props.aiSubmitting,
                                    onClick: _cache[7] || (_cache[7] = $event => (_ctx.$emit('open-batch-ai-generate')))
                                  }, null, 8, ["title", "disabled"]))
                                : _createCommentVNode$6("", true),
                              (__props.aiEnabled && __props.aiBatchCancelTargets.length)
                                ? (_openBlock$6(), _createBlock$6(_component_VListItem, {
                                    ...
                                    "prepend-icon": "mdi-cancel",
                                    title: "取消 AI 任务",
                                    subtitle: "取消当前选中范围内的 AI 任务",
                                    disabled: __props.aiCancelling,
                                    onClick: _cache[8] || (_cache[8] = $event => (_ctx.$emit('cancel-batch-ai-generate')))
                                  }, null, 8, ["disabled"]))
                                : _createCommentVNode$6("", true),
                              _createVNode$6(_component_VDivider, { class: "my-1" }),
                              _createVNode$6(_component_VListItem, {
                                "prepend-icon": "mdi-timeline-clock",
                                title: "批量调轴",
                                subtitle: "重新处理已选外挂字幕时间轴",
                                disabled: !__props.selectedTimelineTargets.length || __props.timelineFixing || !__props.timelineAvailable,
                                onClick: _cache[9] || (_cache[9] = $event => (_ctx.$emit('fix-selected-detail-timeline')))
                              }, null, 8, ["disabled"]),
                              _createVNode$6(_component_VListItem, {
                                ...
                                onClick: _cache[10] || (_cache[10] = $event => (_ctx.$emit('restore-selected-backups')))
                              }, null, 8, ["disabled"]),
                              _createVNode$6(_component_VListItem, {
                                class: "danger-menu-item",
                                "prepend-icon": "mdi-delete-sweep-outline",
                                title: "清空选中外挂字幕",
                                subtitle: "危险操作，会先走确认保护",
                                disabled: !__props.selectedTargetIds.length || __props.clearing,
                                onClick: _cache[11] || (_cache[11] = $event => (_ctx.$emit('clear-selected-subtitles')))
                              }, null, 8, ["disabled"])
                            ]),
                            _: 1
                          })
              ...
              : _createCommentVNode$6("", true),
            (__props.visibleTargets.length)
              ? (_openBlock$6(), _createElementBlock$6("div", _hoisted_12$2, [
                  (_openBlock$6(true), _createElementBlock$6(_Fragment$6, null, _renderList$4(__props.visibleTargets, (target) => {
                    return (_openBlock$6(), _createElementBlock$6("div", {
                      ...
                      _createElementVNode$6("div", _hoisted_13$2, _toDisplayString$4(target.media_type === 'tv' ? `E${String(target.episode || 0).padStart(2, '0')}` : 'MOV'), 1),
                      _createElementVNode$6("div", _hoisted_14$2, [
                        _createElementVNode$6("div", _hoisted_15$2, _toDisplayString$4(__props.compactTargetName(target)), 1),
                        _createElementVNode$6("div", _hoisted_16$1, _toDisplayString$4(target.relative_path), 1)
                      ]),
                      (target.has_subtitle)
                      ...
                      (__props.detailExpanded(target))
                        ? (_openBlock$6(), _createElementBlock$6("div", _hoisted_17$1, [
                            _createElementVNode$6("div", _hoisted_18$1, [
                              ...
                              (__props.detailRowForTarget(target).task)
                                ? (_openBlock$6(), _createElementBlock$6("span", _hoisted_19$1, "AI：" + _toDisplayString$4(__props.aiStatusText(__props.detailRowForTarget(target).task)), 1))
                                : _createCommentVNode$6("", true),
                              ...
                              (__props.isStreamTarget(target))
                                ? (_openBlock$6(), _createElementBlock$6("span", _hoisted_20$1, "STRM 资源不启用 AI 生成和智能调轴"))
                                : _createCommentVNode$6("", true)
                            ]),
                            ((target.subtitles || []).length)
                              ? (_openBlock$6(), _createElementBlock$6("div", _hoisted_21$1, [
                                  (_openBlock$6(true), _createElementBlock$6(_Fragment$6, null, _renderList$4(target.subtitles, (subtitle) => {
                                    return (_openBlock$6(), _createElementBlock$6("div", {
                                      key: subtitle.path,
                                      class: "subtitle-history-item"
                                      ...
                                      _createElementVNode$6("div", _hoisted_23, [
                                        _createVNode$6(_component_VBtn, {
                                          size: "small",
                                          variant: "tonal",
                                          color: "warning",
                              ...
                              : (_openBlock$6(), _createElementBlock$6("div", _hoisted_24, " 当前集暂无外挂字幕。 "))
                          ]))
                        : _createCommentVNode$6("", true)
                    ], 2))
                  }), 128))
                ]))
              : (_openBlock$6(), _createElementBlock$6("div", _hoisted_25, _toDisplayString$4(__props.resolving ? '正在读取本地视频目标...' : '这个资源没有本地视频文件。'), 1)),
            (__props.lastWritten.length)
              ? (_openBlock$6(), _createElementBlock$6("div", _hoisted_26, [
                  _cache[21] || (_cache[21] = _createElementVNode$6("div", { class: "section-kicker" }, "写入结果", -1)),
                  (_openBlock$6(true), _createElementBlock$6(_Fragment$6, null, _renderList$4(__props.lastWritten, (item) => {
                    return (_openBlock$6(), _createElementBlock$6("div", {
                      ...
                      (__props.timelineMetaItems(item).length)
                        ? (_openBlock$6(), _createElementBlock$6("div", _hoisted_27, [
...
return (_ctx, _cache) => {
  ...
  return (_openBlock$3(), _createElementBlock$3("section", _hoisted_1$3, [
    _createElementVNode$3("header", _hoisted_2$3, [
      ...
      _cache[13] || (_cache[13] = _createElementVNode$3("span", null, "海拉鲁字幕大师魔改版", -1)),
      _createVNode$3(_component_VBtn, {
        icon: "mdi-refresh",
        variant: "text",
    ...
    _createElementVNode$2("section", _hoisted_2$2, [
      _createElementVNode$2("div", _hoisted_3$2, [
        _createElementVNode$2("div", null, [
          _cache[8] || (_cache[8] = _createElementVNode$2("div", { class: "mobile-overview-label" }, "海拉鲁字幕大师魔改版", -1)),
...
const mobileUiRevision = 'v0.1.88-mod-upstream-mobile-merge';
...
const _sfc_main = {
  ...
  pluginId: {
    type: String,
    default: 'SubtitleManualUploadMobile',
  },
  navKey: {
    type: String,
    default: 'main',
...
const pluginBase = computed(() => `plugin/${props.pluginId || 'SubtitleManualUploadMobile'}`);
  ...
  return (_openBlock(), _createElementBlock(_Fragment, null, [
    (_unref(isMobileViewport))
      ...
      : (_openBlock(), _createElementBlock("div", {
          ...
          "data-mobile-ui-revision": mobileUiRevision
        }, [
          ...
          (!__props.hideTitle)
            ? (_openBlock(), _createElementBlock("div", _hoisted_2, [...(_cache[20] || (_cache[20] = [
                _createElementVNode("div", null, [
                  _createElementVNode("h1", null, "海拉鲁字幕大师魔改版"),
                  _createElementVNode("p", null, "合并上游海拉鲁字幕大师移动端更新，保留真实媒体库路径扫描与魔改批量操作。")
                ], -1)
              ]))]))
            : _createCommentVNode("", true),
          (error.value)
